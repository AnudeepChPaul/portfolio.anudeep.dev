...
const Intro = React.forwardRef((props, ref) => {
  ...
  React.useEffect(() => {
    ...
    const query = document.querySelector(`.${styles.introPosterBackground}`).children
  ...
  return (
    <section className={styles.introSection} ref={ref}>
      <div className={styles.introCinematic}>
        ...
        <hr/>
        <h6 className={styles.designation}>{props.tagline.split('|').map(line => (
          <div key={line}>{line}</div>
        ))}</h6>
      </div>
      <div className={styles.introPoster}>
        <div className={styles.introPosterBackground}>
          <div className={styles.lightSource}></div>
          <div className={styles.lightSourceEffect1}></div>
          <div className={styles.lightSourceEffect2}></div>
          <div className={styles.lightSourceEffect3}></div>
          <div className={styles.lightSourceEffect4}></div>
          <div className={styles.lightSourceEffect5}></div>
        </div>
        <div className={styles.introPosterDrawings}></div>
      </div>
    </section>
  )
})
